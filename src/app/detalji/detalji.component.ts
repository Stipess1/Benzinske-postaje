    ...
    this.service.getCijenik(this.trenutnaBenga.id).subscribe((data: any) => {
      ...
      */
      ...
      for (let i = 0; i < this.cijenikPostaje.length; i++) {
        ...
        if (id.tipGorivaId == 8 && !imeGoriva.includes(id.imeGoriva) && !id.imeGoriva.includes("nije u portfelju") && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
        ...
        } else if (id.tipGorivaId == 2 && !imeGoriva.includes(id.imeGoriva) && !id.imeGoriva.includes("nije u portfelju") && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
          ...
          this.lineChart.data.datasets.push(dataset);
          imeGoriva.push(id.imeGoriva);
        } else if (id.tipGorivaId == 7 && !imeGoriva.includes(id.imeGoriva) && !id.imeGoriva.includes("nije u portfelju") && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
          ...
          this.lineChart.data.datasets.push(dataset);
          imeGoriva.push(id.imeGoriva);
        } else if (id.tipGorivaId == 1 && !imeGoriva.includes(id.imeGoriva) && !id.imeGoriva.includes("nije u portfelju") && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
          ...
          this.lineChart.data.datasets.push(dataset);
          imeGoriva.push(id.imeGoriva);
        } else if (id.tipGorivaId == 9 && !imeGoriva.includes(id.imeGoriva) && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
          ...
          this.lineChart.data.datasets.push(dataset);
          imeGoriva.push(id.imeGoriva);
        } else if (id.tipGorivaId == 6 && !imeGoriva.includes(id.imeGoriva) && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
          ...
          this.lineChart.data.datasets.push(dataset);
          imeGoriva.push(id.imeGoriva);
        } else if (id.tipGorivaId == 5 && !imeGoriva.includes(id.imeGoriva) && this.trenutnaBenga.nadiGorivoPoId(id.gorivoId)) {
          let dataset = {
            label: id.imeGoriva,
            fill: false,
